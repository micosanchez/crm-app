    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {inv.status !== 'paid' ? (
        <div className="no-print">
          <DeleteRecordButton table="invoices" id={inv.id} redirectTo="/invoices" label="invoice"
            confirmMessage="Delete this invoice for good? This can’t be undone." />
        </div>
      ) : (
        <p className="no-print text-xs text-gray-400">Paid invoices can’t be deleted — they’re part of your revenue record.</p>
      )}
    </div>
  );
}
